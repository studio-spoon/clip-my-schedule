    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Clip My Schedule Privacy Policy
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 prose dark:prose-invert max-w-none">
          ...
          <h2>1. 基本方針</h2>
          <p>
            STUDIO SPOON（以下「当社」といいます）は、スケジュール調整サービス「Clip My Schedule」（以下「本サービス」といいます）において、ユーザーの個人情報保護の重要性を認識し、個人情報の保護に関する法律、その他関係法令等を遵守し、適切な取り扱いを実施いたします。
          </p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            <p>
              <strong>STUDIO SPOON</strong><br />
              ウェブサイト: <a href="https://studio-spoon.co.jp/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">https://studio-spoon.co.jp/</a>
            </p>
          </div>
