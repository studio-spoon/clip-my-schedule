          ...
          <div className='flex flex-col sm:flex-row gap-3 items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600'>
            <div className='flex items-center gap-1'>
              <div className='relative'>
                <select
                  value={customTimeStart.split(':')[0] || '09'}
                  onChange={(e) => {
                    const hour = e.target.value;
                    const minute = customTimeStart.split(':')[1] || '00';
                    onCustomTimeStartChange(`${hour}:${minute}`);
                  }}
                  className='border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1 pr-6 text-xs w-14 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer'
                >
                ...
                <div className='absolute inset-y-0 right-1 flex items-center pr-1 pointer-events-none'>
              ...
              <div className='relative'>
                <select
                  value={customTimeStart.split(':')[1] || '00'}
                  onChange={(e) => {
                    const hour = customTimeStart.split(':')[0] || '09';
            ...
            <div className='flex items-center gap-1'>
              <div className='relative'>
                <select
                  value={customTimeEnd.split(':')[0] || '18'}
                  onChange={(e) => {
                    const hour = e.target.value;
                    const minute = customTimeEnd.split(':')[1] || '00';
                    onCustomTimeEndChange(`${hour}:${minute}`);
                  }}
                  className='border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1 pr-6 text-xs w-14 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer'
                >
                  {Array.from({ length: 24 }, (_, i) => {
              ...
              <div className='relative'>
                <select
                  value={customTimeEnd.split(':')[1] || '00'}
                  onChange={(e) => {
                    const hour = customTimeEnd.split(':')[0] || '18';
                    const minute = e.target.value;
                    onCustomTimeEndChange(`${hour}:${minute}`);
                  }}
                  className='border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1 pr-6 text-xs w-14 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer'
